...
import uvicorn
from db import myDatabase, Course
from useCase import studentsUseCase
from dotenv import load_dotenv

app = FastAPI()
db = myDatabase
useCase = studentsUseCase(myDatabase)
load_dotenv()
...
#####################################################################################
################# This is the only method adopting the three layer approach 
################# you can refactor the other methodsas well ;)
#####################################################################################
@app.get("/student/course/{course}")
def getStudentsWithCourse(course: str):
    # some data parsing logic
    # sends data to usecase
    result = useCase.matchStudentsWithCourse(course)
    #gets data from usecase and return it to the client
